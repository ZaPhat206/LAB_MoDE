...
from .config import LoraConfig, MMoELoraConfig
from .eetq import dispatch_eetq
from .gptq import dispatch_gptq
from .hqq import dispatch_hqq
from .layer import Conv2d, LoraLayer, MMoELoraLayer, MMoELoRALinear, dispatch_default
...
class MMoELoraModel(BaseTuner):
    """
    Creates Modality MoE LoRA model from a pretrained transformers model.

    Args:
        model ([`transformers.PreTrainedModel`]): The model to be adapted.
        config ([`MMoELoraConfig`]): The configuration of the Lora model.
    ...
    **Attributes**:
        - **model** ([`transformers.PreTrainedModel`]) -- The model to be adapted.
        - **peft_config** ([`MMoELoraConfig`]): The configuration of the Lora model.
    """
