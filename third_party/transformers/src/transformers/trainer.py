...
def _is_peft_model(model):
    if is_peft_available():
        ...
        try:
            ...
            # either the package is older than 0.7.0, or (in your case) CLMoE/peft
            # simply doesn’t define that class
            pass
        else:
            classes_to_check = (*classes_to_check, PeftMixedModel)
...
class Trainer:
    ...
    def _inner_training_loop(
        self, batch_size=None, args=None, resume_from_checkpoint=None, trial=None, ignore_keys_for_eval=None, use_pgp=False
    ):
